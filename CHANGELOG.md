...
- Fix: restore proven relationship handling, squash failed rId experiments - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Filter styles.xml from template rels during load, then always add - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Fix: preserve template document.xml.rels verbatim to eliminate rId conflicts - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Fix: eliminate duplicate rId in document.xml.rels for template documents - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- Fix: revert rId dedup, restore original styles.xml relationship handling - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- Fix: prevent duplicate rId in document.xml.rels when opening templates - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- Fix: prevent duplicate rId1 in document.xml.rels when opening templates - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Fix: preserve image transparency (alphaModFix) and paragraph layout properties - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- Fix: omit empty w:orient attr and parse sectPr type/titlePg/pgNumType - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
- Fix: preserve all paragraph/run elements and section break types on round-trip - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- Fix: preserve TOC hyperlinks, bookmarks, and paragraph-level elements on round-trip - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))

### 📚 Documentation

- Document.xml.rels (filtering, deduplication, swapping, verbatim - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Documents with Go-serialized XML, even though the OOXML spec allows - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))

### 🎨 Styling

- Styles during load and re-added it at rId1, creating a duplicate. - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))

### ⚙️ Miscellaneous

- After multiple attempts to eliminate the duplicate rId1 in - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Preservation), the only approach that works is the original one: - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- RId1=styles.xml during serialization. - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Investigation revealed that Word requires styles.xml at rId1 for - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Arbitrary rIds. The duplicate rId1 (styles + customXml) produces a - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- "unreadable content" warning but the document opens correctly. - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- The verbatim approach (keeping template rels byte-for-byte identical - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- To original) paradoxically CORRUPTS the file — Word refuses to open - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- It at all. This suggests Word's relationship resolution is sensitive - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- To how document.xml is serialized, not just the rels file content. - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([5936eee](https://github.com/mr-pmillz/wordZero/commit/5936eee0a21f659a5d33ffbcc1224ea99b819022))
- The previous approaches (filtering, deduplicating, swapping rIds) all - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Caused corruption because Word has strict requirements about relationship - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- IDs that aren't documented in the OOXML spec. - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- New approach: track the template relationship count at load time. During - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Save, if no new relationships were added, skip serialization entirely - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- And keep the original template rels bytes verbatim. If new relationships - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Were added, rebuild from the full template rels plus new ones. - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- This eliminates the duplicate rId1 issue because the template's rels - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Are preserved exactly as-is (styles at rId6, customXml at rId1, etc.). - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Also adds nextRelationshipID() helper that scans for the highest existing - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- RId to prevent collisions when adding new relationships to templates. - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([8cf87be](https://github.com/mr-pmillz/wordZero/commit/8cf87bef2ccec7c49b96532cdd30c24c82b1bad5))
- Revert: restore working relationship handling after failed rId fix attempts - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Reverts to the proven working approach (commit 4dbedce) where styles.xml - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Is always prepended as rId1 and filtered from template relationships - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- During load. This creates a duplicate rId1 that Word handles gracefully - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- (shows "unreadable content" dialog but opens successfully). - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Previous attempts to eliminate the duplicate caused worse corruption: - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- - Removing hardcoded rId1: Word can't find styles.xml (fatal) - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- - Deduplicating by ID: drops template relationships (fatal) - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- - Swapping rIds: breaks customXml references (fatal) - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- The duplicate rId1 approach is the only one that works because Word - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Has an undocumented requirement that styles.xml be reachable via rId1 - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- AND template parts must keep their original rIds. - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([663f68b](https://github.com/mr-pmillz/wordZero/commit/663f68b4295755b17168af7dff0a2a388e83edb7))
- Comprehensive fix for the "unreadable content" Word dialog caused by - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- Duplicate rId1 entries when opening and saving template documents. - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- Root cause: The code assumed styles.xml is always rId1 and hardcoded it - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- During serialization. Templates can have styles at any rId (e.g., rId6) - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- And use rId1 for other parts (e.g., customXml). The old approach filtered - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- Four-part fix: - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- 1. Track template origin: Add isFromTemplate field to Document, set true - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
-    in openFromZipReader(), false in New() - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- 2. Preserve all template relationships: Stop filtering styles.xml during - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
-    parseDocumentRelationships() — keep ALL original rIds intact - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- 3. Conditional styles.xml: serializeDocumentRelationships() only adds - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
-    rId1=styles.xml for new documents, not templates - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- 4. Smart rId generation: Replace all len(rels)+2 formulas with - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
-    nextRelationshipID() which scans for the actual highest rId and - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
-    returns max+1, preventing collisions with template rIds - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([de4ade3](https://github.com/mr-pmillz/wordZero/commit/de4ade3e22091b558909668a322d02ba7ca61c2a))
- The previous attempt to deduplicate rId1 (removing styles.xml when - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- Template already had it at rId6) caused Word to fail finding styles, - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- Corrupting the document. Restored the original approach: always add - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- RId1=styles.xml and filter styles.xml from template relationships - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- During load. The duplicate rId1 is tolerated by Word (uses first match). - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([4dbedce](https://github.com/mr-pmillz/wordZero/commit/4dbedce66fbd117be25e7f97a3ec38e28f77c3f6))
- Two changes that work together: - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- 1. serializeDocumentRelationships() — only add styles.xml relationship - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
-    for new documents; skip it when template already has one (at its - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
-    original rId, e.g., rId6 not rId1) - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- 2. Stop filtering styles.xml from documentRelationships during template - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
-    load — the old filter removed styles.xml (at rId6) then serialize - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
-    re-added it at rId1, colliding with the template's rId1 (customXml) - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- The duplicate rId1 caused Word's "unreadable content" repair dialog. - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- Also update CLAUDE.md with Blip transparency and layout property gotchas. - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([33f0bb5](https://github.com/mr-pmillz/wordZero/commit/33f0bb52cff3742d03eabfa6aaa9865795b8952d))
- Revert "fix: prevent duplicate rId1 in document.xml.rels when opening templates" - ([ca8e311](https://github.com/mr-pmillz/wordZero/commit/ca8e3117ff5c3be64f5553f85170d819daaa908e))
- This reverts commit bb3fe8ee7630cf561e75b763817ffc6c319654a1. - ([ca8e311](https://github.com/mr-pmillz/wordZero/commit/ca8e3117ff5c3be64f5553f85170d819daaa908e))
- SerializeDocumentRelationships() hardcoded rId1 for styles.xml, but - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Templates loaded via Open() already have their own rId1 (e.g., for - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- CustomXml/item1.xml). This produced duplicate rId1 entries which caused - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Word to report "unreadable content" and require repair. - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Fix: check if styles.xml relationship already exists from the template - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Before adding it, and deduplicate all relationship IDs during - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Serialization. - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Also update CLAUDE.md with additional OOXML gotchas. - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([bb3fe8e](https://github.com/mr-pmillz/wordZero/commit/bb3fe8ee7630cf561e75b763817ffc6c319654a1))
- Three fixes for document round-trip fidelity: - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- 1. Blip transparency: Add InnerXML field to Blip struct to preserve child - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    elements like <a:alphaModFix amt="5000"/> (5% opacity). The TOC - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    background image was losing its transparency because parseBlipFill() - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    called skipElement() on blip children. - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- 2. Paragraph layout properties: Parse keepNext, keepLines, widowControl, - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    pageBreakBefore, and outlineLvl in parseParagraphProperties(). These - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    control page break behavior — missing keepNext/keepLines/widowControl - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    on the section break paragraph affected cover page layout. - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- 3. Update CLAUDE.md files with round-trip architecture documentation and - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
-    common parser traps. - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([59a335b](https://github.com/mr-pmillz/wordZero/commit/59a335b9f93a8fe9ad8b92b5c459815c75ca556f))
- Two fixes for TOC appearing on wrong page: - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
- 1. PageSizeXML.Orient now uses omitempty — an empty orient="" attribute - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    is invalid OOXML and causes Word to misinterpret the page layout. - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    The original template has no orient attr on portrait sections; our - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    output was emitting orient="" which confused Word's page calculation. - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
- 2. parseSectionProperties() now parses w:type (continuous/nextPage), - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    w:titlePg (title page flag), and w:pgNumType (page numbering) instead - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    of skipping them. The missing w:type="continuous" prevented Word from - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
-    recognizing the section break between cover page and TOC. - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([8852f3b](https://github.com/mr-pmillz/wordZero/commit/8852f3b5c6062d1cb6c0096b4032e86e016f19f5))
- Three interconnected fixes for document round-trip fidelity: - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- 1. parseParagraph() — capture ALL unknown child elements as raw XML instead - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    of only handling specific ones. This preserves hyperlinks (with TOC anchors), - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    bookmarks, SDTs, comment ranges, and any other inline elements. - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- 2. parseRun() — capture ALL unknown run children as raw XML. This preserves - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    tabs, lastRenderedPageBreak, commentReference, noBreakHyphen, etc. - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- 3. parseSectionProperties() — add parsing for w:type (continuous/nextPage), - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    w:titlePg (title page), and w:pgNumType (page numbering). The missing - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    w:type="continuous" was causing the TOC to appear on page 1 instead of - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-    page 2, because the section break between cover page and TOC was lost. - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- Also: - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- - Store paragraph-level sectPr on paragraph.Properties.SectionProperties - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
-   instead of moving it to the document body (fixes section break position) - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- - Add RawXMLContent field to Run for preserved unknown elements - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- - Remove unused parseHyperlinkRuns (replaced by raw XML capture) - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- - Export SetSectionProperties for API users - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([8b0685f](https://github.com/mr-pmillz/wordZero/commit/8b0685f31f86287d4426b5a6f8787a4988895115))
- The TOC was being destroyed during Open→Modify→Save because parseParagraph() - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- Only handled <w:pPr> and <w:r> elements, silently skipping everything else. - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- TOC paragraphs contain <w:hyperlink> elements (wrapping runs with _Toc anchors - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- And PAGEREF field codes) and <w:bookmarkStart>/<w:bookmarkEnd> elements. - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- Fixes: - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Add parseHyperlinkRuns() to extract runs from <w:hyperlink> elements - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Preserve <w:bookmarkStart>/<w:bookmarkEnd> as RawXMLElements on Paragraph - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Add RawXMLElements field to Paragraph struct for round-trip preservation - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Add custom Paragraph.MarshalXML to emit properties, runs, then raw elements - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- Results (template with TOC): - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Field chars: 18 → 171 (hyperlink runs with field codes now preserved) - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - InstrText: 6 → 40 (all instruction texts preserved) - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - Bookmarks: 0 → 90 (all bookmarks preserved) - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- - _Toc references: 0 → 44 (all TOC cross-references preserved) - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com> - ([64007e8](https://github.com/mr-pmillz/wordZero/commit/64007e8d5d7fc0f3a5103e4779237f899d51ba01))
- Chore: update changelog for v1.7.3 - ([a32f232](https://github.com/mr-pmillz/wordZero/commit/a32f2321cc2a627c938c20b1f1fc91b2af6ca53e))
